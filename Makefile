...
protogen:
	protoc --proto_path=proto proto/product_service.proto proto/image_service.proto proto/search_service.proto proto/review_service.proto proto/order_service.proto proto/general.proto proto/auth_service.proto \
